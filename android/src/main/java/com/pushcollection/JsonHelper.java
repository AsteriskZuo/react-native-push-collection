...
class HuaweiPushConfigHelper {
  ...
  public static HuaweiPushConfig fromMap(HashMap json) { return new HuaweiPushConfig((String)json.get("appId")); }
...
class HonorPushConfigHelper {
  ...
  public static HonorPushConfig fromMap(HashMap json) { return new HonorPushConfig((String)json.get("appId")); }
